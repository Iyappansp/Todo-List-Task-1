...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        'bg-background group/calendar p-3 min-w-[280px] [--cell-size:--spacing(8)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent',
      ...
      classNames={{
        ...
        today: cn(
          'ring-1 ring-primary/40 rounded-md data-[selected=true]:rounded-none',
